    ...
    return (
        <section>
            <form className='form' onSubmit={handleSubmit}>
                ...
                <input type="text" name="name" value={tour.name} onChange={handleNameChange} />
                <label htmlFor='image'>Image:</label>
                <input type="text" image_url="image" value={tour.image_url} onChange={handleImageChange} />
                <label htmlFor='price'>Price:</label>
                <input type="text" price="price" value={tour.price} onChange={handlePriceChange} />
                <label htmlFor='days'>Days</label>
                <input type="text" days="days" value={tour.days} onChange={handleDaysChange} />
